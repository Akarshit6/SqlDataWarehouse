...
Script Purpose:
    ...
    consistency, accuracy, and standardization. The checks include:
        - Null or duplicate values in primary keys.
        - Unwanted spaces in string fields.
        - Data standardization and consistency.
        - Invalid or inconsistent date ranges.
        - Referential consistency between related fields.

Usage:
    - Run these checks after loading data into the Silver Layer.
    - Review and resolve any discrepancies returned by the queries.
===============================================================================
*/
